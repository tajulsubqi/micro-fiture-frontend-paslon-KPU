...
const Register: React.FC = () => {
  ...
  return (
    <div className="container my-5 bg-light rounded-3" style={{ width: "500px" }}>
      <h1 className="text-center pt-3 fw-bold flex flex-column" style={{ color: "#5E5A00" }}>
        <div style={{ fontSize: "60px" }}>
          <i className="fa-solid fa-user-lock"></i>
        </div>
        REGISTER
      </h1>
      <form onSubmit={HandleSubmit} className="w-75 mx-auto pt-3 pb-2 ">
        <div className="mb-3">
